...
- 沙箱閘道介面 baseUri: https://xx-sandbox.xxxxxx.xxx/openapi

- 類比閘道介面 baseUri: https://xx-sandbox.xxxxxx.xxx/mock

- 使用者協議和隱私政策

  連結：baseUri+'/Index/agreement'

  如：https://xx-sandbox.xxxxxx.xxx/mock/Index/agreement
...
|參數名|類型|示例|說明|
|--|--|--|--|
|app_id|字串|xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx|appId|
|sign|字串|xxxxxxxxxxxxxxxxxxxxx|數據簽名|
...
app_id=xxxxxxxxxxxxxxxxxxxxx&email=helloworld@gmail.com
...
```
sign = md5('app_id=xxxxxxxxxxxxxxxxxxxxx&email=helloworld@gmail.com'+'274941aa80278e186e4b5e19cd954457f5fb5556');
```

得到簽名值為：xxxxxxxxxxxxxxxxxxxxx

5. 把簽名sign附加到表單數據上提交

app_id=xxxxxxxxxxxxxxxxxxxxx&email=478547665%40qq.com&sign=xxxxxxxxxxxxxxxxxxxxx
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/getGameSetting`

- 參數表

|參數名|類型|示例|說明|
|--|--|--|--|
|app_id|字串|xxxxxxxxxxxxxxxxxxxxx|appId|
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/getCode`
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/login`
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/loginWithPassword`
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/setPassword`
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/changeEmail`
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/getProfile`
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/saveBalance`
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/changeBalance`
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/getRechargeSetting`
...
|qrcode|字串|https://xx-sandbox.xxxxxx.xxx/mock/Player/Utils/qrcode?text=TSF1nCwgsHKx68KSEZRx7Rj5cjKVJrmvfA|錢包二維碼圖片連結|
|remark|字串|本充值僅接收TRC20-BGGC通證。|充值說明文字|


### buyRubbies BGGC兌換紅寶石

URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/buyRubbies`
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/sellRubbies`
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/sellGold`
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/getWithdrawSetting`
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/submitWithdraw`
...
URL: `https://xx-sandbox.xxxxxx.xxx/mock/Player/getAccountLog`
